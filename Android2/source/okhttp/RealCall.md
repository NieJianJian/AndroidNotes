...
final class RealCall implements Call {
    ...
    @Override public void enqueue(Callback responseCallback) {
        ...
        captureCallStackTrace();
        eventListener.callStart(this);
        client.dispatcher().enqueue(new okhttp3.RealCall.AsyncCall(responseCallback));
    }
    ...
    @Override public okhttp3.RealCall clone() {
        return okhttp3.RealCall.newRealCall(client, originalRequest, forWebSocket);
    }
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        void executeOn(ExecutorService executorService) {
            ...
            try {
                ...
                eventListener.callFailed(okhttp3.RealCall.this, ioException);
                responseCallback.onFailure(okhttp3.RealCall.this, ioException);
            } finally {
                if (!success) {
